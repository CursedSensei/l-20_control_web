...
MIDI_CC_TRACK_FX1_2 =53     # value 0-60 for stereo tracks
...
MIDI_CC_SCENE_CHANGE=86

MIDI_SYSEX_TRACK_INFO=82 # b"\x52" # == 82 dec
MIDI_SYSEX_TRACK_INFO=bytearray(b"\x52\x00\x00\x2a")
MIDI_SYSEX_TRACK_COLOR=bytearray(b"\x52\x00\x00\x31\x03")
MIDI_SYSEX_TRACK_RENAME=bytearray(b"\x52\x00\x00\x31\x02")
MIDI_SYSEX_SCENE_CHANGE=bytearray(b"\x52\x00\x00\x31\x01")
MIDI_SYSEX_RECALL_TRACK_INFO=bytearray(b"\x52\x00\x00\x08")
CMD_TRACK_INFO=b"\xf0\x52\x00\x00\x2b\x80\xf7" #F052 0000 2B80 F7
MIDI_SYSEX_END=b"\xf7"
MIDI_SYSEX_START=b"\xf0"

MIDI_CC_TRACK_SCROLL_STEP=88 #channel=11 value 
